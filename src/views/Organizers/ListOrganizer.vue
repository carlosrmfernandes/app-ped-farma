...
<<<<<<< HEAD
    ...
    <b-modal id="bv-modal-example" class="mt-4" size="lg">
      ...
      <div class="d-block text-center">
        <div class="col-md-12">
          <div class="alert alert-success" v-if="hadSuccess" role="alert">{{hadSuccess}}</div>
          <div class="alert alert-danger" v-if="hadError" role="alert">{{hadError}}</div>
        </div>
        <div class="row flex">
          <div class="form-group m-2">
            ...
            <input
              ...
              v-model="form.name"
              id="event-name"
              placeholder="Nome do Organizador de Evento"
              :disabled="!isEditable"
            />
          </div>
        </div>
...
<<<<<<< HEAD
    ...
    async GetCompany() {
      ...
      try {
        const result = await this.axios.get(`/companies/${this.editID}`);
